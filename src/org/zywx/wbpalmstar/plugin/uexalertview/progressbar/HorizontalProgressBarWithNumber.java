package org.zywx.wbpalmstar.plugin.uexalertview.progressbar;
...
public class HorizontalProgressBarWithNumber extends ProgressBar {
	...
	private static final int DEFAULT_HEIGHT_REACHED_PROGRESS_BAR = 16;
	private static final int DEFAULT_HEIGHT_UNREACHED_PROGRESS_BAR = 16;
	...
	private void obtainStyledAttributes(AttributeSet attrs) {
		...
		// DEFAULT_TEXT_COLOR);
		// mTextSize = (int)
		// attributes.getDimension(R.styleable.HorizontalProgressBarWithNumber_progress_text_size,
		// mTextSize);
		//
		// mReachedBarColor =
		...
		// mReachedProgressBarHeight = (int)
		// attributes.getDimension(R.styleable.HorizontalProgressBarWithNumber_progress_reached_bar_height,
		// mReachedProgressBarHeight);
		// mUnReachedProgressBarHeight = (int)
		// attributes.getDimension(R.styleable.HorizontalProgressBarWithNumber_progress_unreached_bar_height,
		// mUnReachedProgressBarHeight);
		// mTextOffset = (int)
		// attributes.getDimension(R.styleable.HorizontalProgressBarWithNumber_progress_text_offset,
		// mTextOffset);
		//
		// int textVisible =
